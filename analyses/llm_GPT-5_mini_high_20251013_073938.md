...
**Type:** llm
**Generated:** 2025-10-13 07:39:38

---

## Model Overview

The model is named **GPT-5 mini (high)**, created by **OpenAI** (ID: e67e56e3-15cd-43db-b679-da4660a69f41). It belongs to the **LLMs (Artificial Analysis â LLMs)** category, which includes 16 entries primarily from OpenAI and Meta, focusing on performance metrics like artificial analysis indices, MMLU Pro, and speed evaluations. This variant appears to be a high-performance configuration of the GPT-5 mini series, released on **2025-08-07**. 

Key specifications and capabilities, based on the provided data, include a focus on reasoning, coding, and mathematical tasks, as evidenced by strong benchmark scores in these areas. It supports text-based input and output, with median output speed of 65.498 tokens per second and a time to first token of 92.334 seconds. No explicit details on context length, modality support (e.g., vision or audio), or multimodal capabilities are provided in the data for this model, though other GPT-5 variants in the dataset suggest potential for text+image handling (e.g., GPT-5 Pro in OpenRouter). The model is positioned as a compact yet capable entry in OpenAI's lineup, balancing intelligence with cost efficiency compared to larger siblings like GPT-5 (high).

## Performance Analysis

Benchmark scores from the evaluations dataset highlight strengths in mathematics, general knowledge, coding, and reasoning:

- **Mathematics and Reasoning**: High artificial_analysis_math_index of 90.7 (out of 100), GPQA (Graduate-Level Google-Proof Q&A) at 0.828, AIME_25 (American Invitational Mathematics Examination, 25 problems) at 0.907, and MMLU Pro (Massive Multitask Language Understanding Pro) at 0.837. These indicate robust performance on complex math and knowledge-based reasoning tasks.
- **Coding and Instruction Following**: Artificial_analysis_coding_index of 51.4, LiveCodeBench at 0.838, IFBench (Instruction-Following Benchmark) at 0.754, SciCode at 0.392, and Tau2 at 0.684. TerminalBench Hard scores 0.312, suggesting solid but not top-tier terminal-based coding.
- **General Intelligence and Other**: Artificial_analysis_intelligence_index of 64.3, HLE (Human Level Evaluation?) at 0.197, and LCR (Long-Context Retrieval?) at 0.68. Scores for AIME and Math_500 are null, indicating potential gaps in some advanced math evaluations.
- **Speed Metrics**: Median output tokens per second at 65.498, with a notably high time to first token (92.334 seconds), which may reflect a deliberate high-reasoning mode that prioritizes depth over immediacy.

Comparisons with similar models in the provided LLMs dataset:
- **Vs. GPT-5 (high)** (OpenAI, same release): Lower intelligence index (64.3 vs. 68.5), MMLU Pro (0.837 vs. 0.871), and math index (90.7 vs. 94.3), but similar coding (51.4 vs. 52.7) and faster blended pricing. GPT-5 mini (high) trades some peak performance for efficiency.
- **Vs. o3** (OpenAI, 2025-04-16): Comparable intelligence (64.3 vs. 65.5), but lower MMLU Pro (0.837 vs. 0.853) and slower output speed (65.498 tokens/sec vs. 235.15). o3 edges out in overall benchmarks but at higher cost.
- **Vs. GPT-5 mini variants**: Outperforms GPT-5 mini (minimal) (intelligence 41.6, MMLU Pro 0.775) and GPT-5 mini (medium) (intelligence 60.8, MMLU Pro 0.828) in most metrics, positioning it as the "high" tier for balanced capabilities.
- **Vs. Meta Models** (e.g., Llama 3.3 Instruct 70B): Significantly superior, with higher intelligence (64.3 vs. 27.9), MMLU Pro (0.837 vs. 0.713), and math index (90.7 vs. 7.7), highlighting OpenAI's lead in the dataset.
- **Vs. Google Models** (e.g., Gemini 2.5 Pro): Close in intelligence (64.3 vs. 59.6) and MMLU Pro (0.837 vs. 0.862), but GPT-5 mini (high) scores higher in GPQA (0.828 vs. 0.844) and coding (LiveCodeBench 0.838 vs. 0.801).

In the broader OpenRouter catalogue (35 models), it aligns with high-end OpenAI entries like GPT-5 Pro (context 400000 tokens, reasoning modes) but lacks direct cross-dataset benchmarks. Overall, it ranks near the top of the LLMs dataset for intelligence (second to GPT-5 high at 68.5) and math, but trails in speed compared to faster OpenAI models like o3.

Information on some benchmarks (e.g., full AIME, Math_500) is null, so comparisons in those areas are unavailable.

## Technical Details

No explicit architecture details (e.g., parameter count, transformer layers, or MoE usage) are provided in the data for GPT-5 mini (high), though OpenAI models in the dataset (e.g., GPT-5 high) imply a transformer-based design optimized for reasoning. It supports standard LLM parameters inferred from similar models, including temperature, top_p, and tool use (seen in OpenRouter GPT-5 variants).

Input/output specifications:
- **Input**: Primarily text-based, with potential for images/files based on GPT-5 series (e.g., GPT-5 Pro supports text+image+file). Context length is not specified, but comparable OpenAI models range from 128k to 400k tokens.
- **Output**: Text generation, with median 65.498 tokens/second. Time to first token is 92.334 seconds, suggesting a "high" mode with extended pre-generation processing for reasoning. Supports structured outputs and tool calling, as per OpenAI patterns in the data.
- **Other**: No details on tokenizer (likely GPT-style), modality (text-focused, no audio/vision confirmed), or instruct type.

The model is part of OpenAI's GPT-5 family, with variants like (high), (medium), and (minimal) indicating tunable performance levels.
...
- Input: $0.25
- Output: $2.00
- Blended (3:1 input:output ratio): $0.688

This positions it as a cost-effective option compared to larger OpenAI models:
- Cheaper than GPT-5 (high) (input $1.25, output $10, blended $3.438) and o3 (input $2, output $8, blended $3.5).
- Similar to other GPT-5 mini variants (e.g., minimal and medium share the same pricing).
- In the OpenRouter catalogue context, it's more expensive than low-cost entries (e.g., xAI Grok 4 Fast at $0.0000005 completion) but competitive for high-intelligence tasks.

Availability: Accessible via OpenAI's API (slug: gpt-5-mini), likely through platforms like OpenRouter (as seen in catalogue listings for similar GPT-5 models). No free tier or on-premises details are provided. Released on 2025-08-07, it appears in the internal LLMs benchmark dataset but not explicitly in the OpenRouter snapshot, suggesting primary availability through OpenAI's ecosystem.

## Use Cases & Applications

Recommended applications, based on performance data:
- **Mathematical and Reasoning Tasks**: Strong math index (90.7) and GPQA (0.828) make it ideal for STEM problem-solving, proofs, and graduate-level Q&A.
- **Coding and Development**: High LiveCodeBench (0.838) and Tau2 (0.684) suit code generation, debugging, and instruction-following in programming (e.g., agentic workflows, similar to GPT-5 Codex).
- **General Knowledge and Instruction Following**: MMLU Pro (0.837) and IFBench (0.754) support educational tools, chat assistants, and multi-turn dialogues.
- **Long-Context Retrieval**: LCR (0.68) indicates utility in RAG systems or document analysis.

Strengths:
- Balanced high performance in math (90.7 index) and coding (51.4 index) at lower cost than full GPT-5.
- Superior to Meta/Google models in intelligence and benchmarks, per dataset.
- Efficient for reasoning-heavy tasks, with visible strengths in OpenAI's ecosystem.

Limitations:
- Slower time to first token (92.334s) may hinder real-time applications.
- Lower HLE (0.197) and TerminalBench Hard (0.312) suggest weaknesses in human-like evaluation and advanced terminal tasks.
- Null scores for AIME and Math_500 limit insights into peak math capabilities.
- No multimodal or long-context specifics, potentially restricting vision/audio use cases compared to OpenRouter models like Qwen3 VL.

Overall, best for cost-sensitive, reasoning-intensive apps like tutoring, code assistants, or research agents, but not ultra-fast inference.

## Community & Updates

The model was released on 2025-08-07 as part of OpenAI's GPT-5 series expansions, following earlier variants like o3 (2025-04-16) and aligning with trends in the LLMs dataset toward higher intelligence indices (e.g., GPT-5 high at 68.5). No specific updates beyond release are detailed, though the dataset includes related models like GPT-5 mini (medium/minimal), indicating iterative tuning for performance tiers.

No user feedback, adoption metrics, or community discussions are present in the provided datasets. The OpenRouter catalogue highlights broader trends in OpenAI models (e.g., reasoning modes in GPT-5 Pro), suggesting growing adoption for agentic and long-context use, but nothing model-specific.
    ...
    "category_summaries": [
      {
        "id": "llms",
        "label": "Artificial Analysis — LLMs",
        "summary": "The LLMs dataset contains 16 entries, predominantly from 'OpenAI' and 'Meta', with performance indexed by various artificial analysis metrics, MMLU Pro, and speed metrics.",
        "top_items": [
          {
            "name": "GPT-5 (high)",
            "provider": "OpenAI",
            ...
            "notes": "Highest intelligence index (68.5) and mmlu_pro (0.871) among listed models."
          },
          {
            "name": "o3",
            "provider": "OpenAI",
            ...
            "notes": "Strong performance metrics compared to other OpenAI models, with 235.15 tokens/sec median output."
          },
          {
            ...
            "notes": "One of the Meta models listed, showing lower but present evaluation scores."
          }
        ]
      },
      {
        "id": "openrouter",
        "label": "OpenRouter Catalogue",
        "summary": "The OpenRouter Catalogue includes 35 models from diverse vendors like Google, OpenAI, Qwen, and DeepSeek, showcasing a range of multimodality, context lengths (up to 2,000,000 tokens), and reasoning capabilities.",
        "top_items": [
          {
            ...
            "key_metrics": {
              ...
              "prompt_pricing": "0.000015"
            },
            "notes": "Highest prompt pricing listed among OpenRouter entries."
          },
          {
            ...
            "key_metrics": {
              ...
              "completion_pricing": "0.000015"
            },
            "notes": "Features one of the longest context lengths at 1,000,000 tokens."
          },
          {
            ...
            "key_metrics": {
              ...
              "completion_pricing": "0.0000005"
            },
            "notes": "Has the maximum context length listed (2,000,000 tokens)."
          }
        ]
      }
    ],
    "highlights": [
      "OpenAI's 'GPT-5 (high)' model leads the LLMs dataset with an Artificial Analysis Intelligence Index of 68.5 and an MMLU Pro score of 0.871.",
      "OpenRouter models exhibit wide variance in pricing, with costs ranging from free (0) up to $0.000015 per 1M prompt tokens for GPT-5 Pro.",
      "The OpenRouter catalogue displays models with extremely long context windows, peaking at 2,000,000 tokens for 'xAI: Grok 4 Fast'.",
      "Several models across both datasets offer 'reasoning' or 'thinking' modes, indicating a focus on complex problem-solving abilities: GPT-5 versions, Grok 4 types, Qwen thinking variants, and DeepSeek Terminus."
    ],
    "markdown_summary": "# Structured Data Analysis\n\nTwo datasets were analyzed: **Artificial Analysis — LLMs** (Internal Benchmark Data) and **OpenRouter Catalogue** (External API Models).\n\n## Artificial Analysis — LLMs\nThe LLMs dataset features 16 models, mainly from **OpenAI** and **Meta**. Evaluation is quantified using various indices like `artificial_analysis_intelligence_index` and public benchmarks like `mmlu_pro`.\n\n*   **Top Performer (Internal Benchmark):** **GPT-5 (high)** from **OpenAI** achieves the highest intelligence index (68.5) and MMLU Pro score (0.871).\n*   **Speed:** OpenAI's **o3** exhibits strong performance metrics (Intelligence Index 65.5) while maintaining a fast inference speed of 235.15 tokens/sec.\n*   **Meta Models:** Models like **Llama 3.3 Instruct 70B** show entry-level scores relative to the top OpenAI entries in this set.\n\n## OpenRouter Catalogue\nThe OpenRouter Catalogue contains 35 models from providers including Google, OpenAI, Qwen, Anthropic, and DeepSeek, highlighting strong trends toward long context and hybrid reasoning.\n\n*   **Context Length:** The maximum context length observed is **2,000,000 tokens** from **xAI: Grok 4 Fast**.\n*   **High-End Models:** **OpenAI: GPT-5 Pro** and **Anthropic: Claude Sonnet 4.5** are prominent, with Claude Sonnet 4.5 supporting a 1,000,000 token context window.\n*   **Reasoning Features:** Many models, such as those from **Qwen** (e.g., Qwen3 Next 80B A3B Thinking) and **DeepSeek** (e.g., DeepSeek V3.1 Terminus), explicitly support configurable reasoning modes, controlling intermediate thought processes.\n*   **Cost Leaders:** Several models, including those from Baidu and Meituan, offer very low entry pricing, sometimes free, for standard usage.\n\n**Overall Highlights:** There is a clear competitive landscape featuring models specialized for reasoning (via 'thinking' modes), massive context handling, and multimodal capabilities (Google, Baidu, Qwen models).",
    ...
    "llms": [
      {
        ...
        "median_output_tokens_per_second": 235.712,
        "median_time_to_first_token_seconds": 0.389,
        "median_time_to_first_answer_token": 8.874
      },
      {
        ...
        "median_output_tokens_per_second": 326.85,
        "median_time_to_first_token_seconds": 0.454,
        "median_time_to_first_answer_token": 6.573
      },
      {
        ...
        "median_time_to_first_token_seconds": 69.067,
        "median_time_to_first_answer_token": 69.067
      },
      {
        ...
        "median_output_tokens_per_second": 71.642,
        "median_time_to_first_token_seconds": 1.063,
        "median_time_to_first_answer_token": 1.063
      },
      {
        ...
        "median_output_tokens_per_second": 235.15,
        "median_time_to_first_token_seconds": 11.318,
        "median_time_to_first_answer_token": 11.318
      },
      {
        ...
        "median_output_tokens_per_second": 102.65,
        "median_time_to_first_token_seconds": 1.279,
        "median_time_to_first_answer_token": 1.279
      },
      {
        ...
        "median_time_to_first_token_seconds": 74.186,
        "median_time_to_first_answer_token": 74.186
      },
      {
        ...
        "median_output_tokens_per_second": 184.889,
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 65.498,
        "median_time_to_first_token_seconds": 92.334,
        "median_time_to_first_answer_token": 92.334
      },
      {
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 177.087,
        "median_time_to_first_token_seconds": 37.124,
        "median_time_to_first_answer_token": 37.124
      },
      {
        ...
        "median_output_tokens_per_second": 71.505,
        "median_time_to_first_token_seconds": 28.707,
        "median_time_to_first_answer_token": 28.707
      },
      {
        ...
        "median_output_tokens_per_second": 150.638,
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 167.949,
        "median_time_to_first_token_seconds": 36.377,
        "median_time_to_first_answer_token": 36.377
      },
      {
        ...
        "median_output_tokens_per_second": 185.282,
        "median_time_to_first_token_seconds": 17.739,
        "median_time_to_first_answer_token": 17.739
      },
      {
        ...
        "median_output_tokens_per_second": 121.625,
        "median_time_to_first_token_seconds": 0.439,
        "median_time_to_first_answer_token": 0.439
      },
      {
        ...
        "median_output_tokens_per_second": 115.501,
        "median_time_to_first_token_seconds": 0.412,
        "median_time_to_first_answer_token": 0.412
      },
      {
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 32.02,
      ...
      },
      {
        ...
        "median_time_to_first_token_seconds": 0.334,
        "median_time_to_first_answer_token": 0.334
      },
      {
        ...
        "median_output_tokens_per_second": 69.074,
        "median_time_to_first_token_seconds": 0.447,
        "median_time_to_first_answer_token": 0.447
      },
      {
        ...
        "median_output_tokens_per_second": 126.774,
        "median_time_to_first_token_seconds": 0.353,
        "median_time_to_first_answer_token": 0.353
      },
      {
        ...
        "median_output_tokens_per_second": 119.019,
        "median_time_to_first_token_seconds": 0.437,
        "median_time_to_first_answer_token": 0.437
      },
      {
        ...
        "median_output_tokens_per_second": 51.079,
        "median_time_to_first_token_seconds": 1.479,
        "median_time_to_first_answer_token": 1.479
      },
      {
        ...
        "median_output_tokens_per_second": 48.596,
        "median_time_to_first_token_seconds": 0.614,
        "median_time_to_first_answer_token": 0.614
      },
      {
        ...
        "median_output_tokens_per_second": 49.63,
        "median_time_to_first_token_seconds": 0.411,
        "median_time_to_first_answer_token": 0.411
      },
      {
        ...
        "median_output_tokens_per_second": 154.798,
        "median_time_to_first_token_seconds": 29.142,
        "median_time_to_first_answer_token": 29.142
      },
      {
        ...
        "median_output_tokens_per_second": 235.572,
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 534.014,
      ...
      },
      {
        ...
        "median_output_tokens_per_second": 264.653,
        "median_time_to_first_token_seconds": 8.796,
        "median_time_to_first_answer_token": 8.796
      }
    ],
    "openrouter": [
      {
